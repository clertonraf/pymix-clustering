...
def guess_include_dirs():
    ...
    numpypath =  '/home/clerton/.local'+ '/lib/python' +pyvs + '/site-packages/numpy/core/include/numpy'  # path to arrayobject.h
...
setup(name="pymix",
      ...
      py_modules = ['mixture','mixtureHMM','mixtureBinomial','mixtureunittests','alphabet', 'plotMixture','TabDataSet',
